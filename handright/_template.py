...
class Template(object):
    ...
    def __init__(
        ...
        **EXPERIMENT**
        ...
        self.set_word_spacing_decrease(word_spacing_decrease)
    ...
    def __eq__(self, other) -> bool:
        return (isinstance(other, Template)
                ...
                and self._word_spacing_decrease == other._word_spacing_decrease
    ...
    def set_word_spacing_decrease(self, word_spacing_decrease: float = 0) -> None:
        self._word_spacing_decrease = word_spacing_decrease
    ...
    def get_word_spacing_decrease(self) -> float:
        return self._word_spacing_decrease
    ...
    def __repr__(self) -> str:
        ...
        return ("{class_name}("
                ...
                "word_spacing_decrease={self._word_spacing_decrease}, "
